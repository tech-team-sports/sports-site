...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getRequestHeaders, getRequestURL, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file://D:/sports-site-1/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/sports-site-1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/sports-site-1/node_modules/devalue/index.js';
import destr from 'file://D:/sports-site-1/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, joinRelativeURL, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://D:/sports-site-1/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/sports-site-1/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/sports-site-1/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/sports-site-1/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/sports-site-1/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/sports-site-1/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/sports-site-1/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/sports-site-1/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://D:/sports-site-1/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/sports-site-1/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/sports-site-1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/sports-site-1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/sports-site-1/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola, createConsola } from 'file://D:/sports-site-1/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/sports-site-1/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/sports-site-1/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file://D:/sports-site-1/node_modules/vue/index.mjs';
import devalue from 'file://D:/sports-site-1/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { basename, isAbsolute } from 'file://D:/sports-site-1/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://D:/sports-site-1/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file://D:/sports-site-1/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/sports-site-1/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/sports-site-1/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/sports-site-1/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/sports-site-1/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\sports-site-1","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\sports-site-1\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\sports-site-1\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\sports-site-1\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\sports-site-1\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9bCXcGrYpU = defineNitroPlugin(async (nitroApp) => {
...
const _54QrZmxbfh = defineNitroPlugin(async (nitroApp) => {
...
const _SLT633 = defineCachedEventHandler(async (event) => {
...
const _miHWGR = defineEventHandler(async (e) => {
...
const _MISTQn = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _6W8DwX = defineEventHandler(async (e) => {
...
const _y3cfGl = defineEventHandler(async (e) => {
...
const _NjAckM = defineEventHandler(async (e) => {
...
const _m4Mnoz = defineEventHandler(async (e) => {
  const nitro = useNitroApp();
...
const _JDL1JJ = defineEventHandler(async (e) => {
...
const _bEE7Wr = defineEventHandler(async (e) => {
...
const _0od006 = defineEventHandler(async (e) => {
...
const _NUsEOn = lazyEventHandler(() => {
...
const _lazy_V5nEhA = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_V5nEhA, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _SLT633, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _miHWGR, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _MISTQn, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _6W8DwX, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _y3cfGl, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _NjAckM, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _m4Mnoz, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _JDL1JJ, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _bEE7Wr, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _0od006, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _NUsEOn, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_V5nEhA, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_V5nEhA, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/sports-site-1/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/sports-site-1/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
