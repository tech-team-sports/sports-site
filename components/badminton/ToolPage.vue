<template>
  <div class="badminton-equipment">
    ...
    <section>
      ...
      <h3>素材</h3>
      <p>バドミントンラケットの素材にはさまざまな種類がありますが、最も一般的で人気があるのはカーボン素材です。<br />
        カーボンは非常に軽量でありながら、耐久性にも優れているため、長時間のプレイでも性能が維持されやすい特徴があります。
        また、振動吸収性にも優れ、手に伝わる衝撃を軽減するため、プレイヤーの負担を減らすことができます。
        さらに、カーボンは高い反発力を持っているため、強力なショットを打つことが可能です。
        アルミ製のラケットもあり、特に初心者向けとして人気です。アルミ製は軽くて安価ですが、耐久性や反発力ではカーボンに劣ります。
        そのため、競技レベルのプレイヤーにはカーボンが推奨されますが、軽さを重視する場合やコストを抑えたい場合にはアルミ製も選択肢として考えられます。</p>
      
      <h3>バランス</h3>
      <p>バドミントンラケットのバランスには主に3種類、ヘッドヘビー、イーブンバランス、ヘッドライトがあります。<br />
        ヘッドヘビー型は、ラケットの重心がヘッド（先端）に寄っているため、強力なショットを打つことができます。
        特に攻撃的なプレースタイルを好む選手に向いており、スマッシュやドロップショットのパワーを増強するために効果的です。<br />
        イーブンバランス型は、ラケットの重心が均等に分布しており、攻守のバランスが取れた性能を持っています。
        オールラウンドプレーヤーに最適で、素早い反応を求められる状況でも対応可能です。<br />
        ヘッドライト型は、ラケットの重心がグリップ側に寄っているため、軽量で操作性に優れています。
    ...
    <section>
      ...
      <h3>素材</h3>
      <p>フェザーシャトルはガチョウやアヒルの羽を使用しており、羽根の質感とバランスが非常に重要です。<br />
        自然の羽根を使うため、飛行性能やコントロール性に優れていますが、耐久性が低く、特に強いショットや衝撃に弱いため、試合で使用されることが一般的です。<br />
